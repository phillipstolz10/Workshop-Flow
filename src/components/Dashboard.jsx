...
export default function Dashboard({ data, onOpenProject, onNewProject, onDeleteProject }) {
  ...
  return (
    <div className="page">
      ...
      <div className="dash-list">
        {projects.map((p) => (
          <div key={p.id} className="dash-row dash-row-deletable" onClick={() => onOpenProject(p.id)}>
